...
def make_dataset_fromlst(listfilename):
    ...
    with open(listfilename) as f:
        ...
        for x in content:
            ...
            imgname = imgname.replace('/home/hxx', '/seagate/zhouhao/CANet')
            depthname = depthname.replace('/home/hxx', '/seagate/zhouhao/CANet')
            segname = segname.replace('/home/hxx', '/seagate/zhouhao/CANet')
            images += [imgname]
            segs += [segname]
            depths += [depthname]
